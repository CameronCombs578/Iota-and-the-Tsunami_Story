...
function showScene9Route1Path1() {
    playContent.innerHTML = `
        <div class="story-text">
            ...
            <p>The boy cautiously took the scope from Iota and looked through it to see the wall of water. "Oh my goddness, you two are telling the truth. What can we do?" the boy said. "Warn the vilagers before it is too late," Grace said. Imeadiatley, the boy ran towards the vilage. "Thank you very much... uh what is your name?" Iota yelled. "Mark!" the boy said as he ran full speed through the woods. "Thank you Mark!" Grace and Iota yelled as he disappeared into the trees.
...
function showScene10Route1Path1() {
    playContent.innerHTML = `
        <div class="story-text">
            ...
            <p>"Wait a second." Iota said. "What about us!" Iota began to yell for Mark, but he was out of sight. "Oh no oh no," Iota began to say say. "Its okay Iota, we can try to get to the mountains where it is safe." "How!?" Iota said. "I..uh..don't know." "We can't stay here. How is you leg fealing?" "Okay I guss," Grace said as she move it an inch from the ground" "I think I can make it with your help now." "Then we should go." Iota said. The two of them began to walk towards the mountains where they would be safe from the tsunami.
            <button id="Chapter4option1">Return to the village</button>
            <button id="Chapter4option2">Wait for Help</button>
        </div>
    `;
...
function showScene11Route1Path1() {
    playContent.innerHTML = `
        <div class="story-text">
            ...
            <p>Mark ran into the vailage and yelled from the top of his lungs, "TSUNAMI!" "What about a tsunami?" a villager said. "One is heading our way, we need to evacuate!" Mark replied. The croud began to patiently wait for more. "What?" Mark said. "Enough with the game boy, don't you have homework to do." "What? No! I am serious. Go to the shore and look with a scope towards the sea!" Mark said as he motioned the actions. "Hmmm..." "Please trust me... wait, not don't trust me, look for yourself!" Mark said as he raced to the shore. Only a few vilagers walked after him and were astonished when they saw the wall of water. "You were right after all," they said. Each vilager that witnessed the tsunami warned one of their freinds, which warned their friend. This process continued until half of the villagers were ready to move to the mountains while the other half were not.
            <p>"You all are trusting in a boy's game while we are basing our action on evidence. "There is evedience, just look..." "We have heard the story but we still do not believe." "Why are they so resistant?" Mark said to one of the adults. "The half of villagers that are staying are the rich ones, they have businesses here and are not willing to leave." "Friends," Mr. Jerry said as he stood up on a box. "Do not listen to this boy and his games. If a real tsunami is coming we can stand it." The crowd yelled with support. "It is no use," Mark said, "ya your right. you cannot trick us." "He is not tricking you," "Who said that," Jerry said as he looked as Grace and Iota enter into the village. "After buying a scope, we sat by the shore and saw the tsunami coming. Please believe us." "Well... uh... you... you are probably making up this joke with him." Jerry thought aloud to support his case. "Mayber they are right," one of Jerry's supporters said as he joined the other half of villagers. "Well, you can go, but we are going stay," Jerry and his supportes said together. Iota, Grace, Mark, and half of the villagers walked towards the mountain.
